...
<div class="container-fluid">
	<div class="section-list">
		<div class="section page-header">
			<h5 class="heading">{{$collection->name}}</h5>
			<div class="action">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="/collections/edit/{{$collection->id}}"><i
								class="fas fa-pen icon-r"></i>Edit</a>
						<a class="dropdown-item" href="/collections/delete/{{$collection->id}}"><i
		...
		<div class="section add-new">
			<form method="POST" action="/bookmarks/new">
				...
				<input type="url" class="form-control" name="bookmark_url"
					placeholder="https:// - enter a url here to save quickly..">
			</form>
		</div>
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
								<a class="dropdown-item" href="/bookmarks/edit/{{$bookmark->id}}"><i
										class="far fa-edit icon-r"></i>Edit</a>
